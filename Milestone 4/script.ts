window.addEventListener('load', () => {
    ...
    const baseUrl = 'http://127.0.0.1:5501/Editable_Resume/Preview_Resume/EditableResume.html'; // Your Vercel deployment URL
    ...
    document.getElementById('editBtn')!.addEventListener('click', () => {
        window.location.href = '../User_Input/form.html'; // Navigate to resume input form
    });
